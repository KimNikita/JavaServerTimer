...
public class ServerFrame extends javax.swing.JFrame {
    ...
    public ServerFrame() {
        ...
        server = new Server(model1, model2);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            server.run(InetAddress.getByName(this.jTextField1.getText()), Integer.parseInt(this.jTextField2.getText()));
            t = new Thread(
                    () -> {
                        while (true) {
                            this.jLabel4.setText(server.getTime());
                        }
                    }
            );
            t.setDaemon(true);
